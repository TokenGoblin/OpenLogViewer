...
- [Editing a tune](Editing-a-tune) — the confirmation gate every write passes through
- [Live connection](Live-connection)
- [Command line](Command-line) — `--mcp`
- [Troubleshooting ▸ AI agent (MCP)](Troubleshooting#ai-agent-mcp)
