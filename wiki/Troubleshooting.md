...
| The agent cannot clear fault codes or restore a tune | Neither is offered as a tool | Deliberate. Both are done by a person — see [mcp-server.md](AI-agent-access-MCP) |
