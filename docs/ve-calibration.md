...
Use the [data filters](histogram-and-scatter.md#data-filters) to exclude what you
...
| Edit the ECU directly | Switch to **Calibration** on a live connection and make the changes there — see [Editing a tune](tune-editing.md) |
...
- [Histogram and scatter](histogram-and-scatter.md)
