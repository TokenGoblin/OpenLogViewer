...
scatter](histogram-and-scatter.md).
...
[Firmware definitions and channels](ini-and-channels.md) for how.
...
channels](calculated-channels.md).
...
The syntax is the same as a [calculated channel](calculated-channels.md),
...
`solarized-dark`. See [Command line](command-line.md).
...
dialogs. See [Command line](command-line.md).
...
The binary format is documented in [The MLG log format](mlg-format.md). If a log
