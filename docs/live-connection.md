...
See [Firmware definitions and channels](ini-and-channels.md) for how a file is
...
- **Connect to a Wi-Fi OBD2 adapter** — see [OBD2](obd2.md)
- **Connect over SSM (Subaru)** — see [Subaru SSM](subaru-ssm.md)
...
See [Editing a tune](tune-editing.md) for what happens when you do write.
...
| --- | --- | --- |
| The device is not in the **Connect ▾** list | It is a Bluetooth LE adapter that has not paired, or a Wi-Fi dongle | BLE adapters appear with `(Bluetooth LE)`; Wi-Fi dongles appear in no list — see [OBD2](obd2.md) |
...
- [OBD2](obd2.md) — standard vehicles through an ELM327
- [Subaru SSM](subaru-ssm.md)
- [Editing a tune](tune-editing.md)
